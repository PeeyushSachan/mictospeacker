...
class _BannerViewState extends State<BannerView> {
  ...
  Widget build(BuildContext context) {
    ...
    final width = widget.size.width <= 0
        ? mediaSize.width
        : widget.size.width.toDouble();
    final height = widget.size.height <= 0
        ? 50.0
        : widget.size.height.toDouble();

    final child = _bannerAd == null
    ...
    return Align(
      ...
      child: Container(
        ...
        child: _isLoading
            ? _LoadingPlaceholder(width: width, height: height)
            : child,
      ),
    );
  }
